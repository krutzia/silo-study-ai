    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="glass rounded-2xl p-8">
          <Button
            variant="outline"
            className="w-full mb-6 py-5 border-border/50 text-foreground hover:bg-muted/50"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full gradient-primary text-primary-foreground py-5 rounded-xl hover:opacity-90"
            >
